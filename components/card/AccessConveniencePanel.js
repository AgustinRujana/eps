    ...
    <section className=''>
      <div className='relative w-fit mx-auto'>
        ...
        <div className='z-10 bg-darkBlue'>
          <p className='sm:text-4xl text-2xl p-6 text-teal-400 font-extrabold uppercase'>
      ...
      <div className='p-4 sm:m-12 my-8 rounded-xl shadow-2xl bg-slate-50 grid gap-4 grid-cols-1 sm:grid-cols-2'>
        {props.content.map((listItem) => (
          <p className='col-span-1 flex items-center sm:text-base text-sm leading-tight tracking-tight'>
            <BadgeCheckIcon className='h-6 mr-1 text-green-600 flex-shrink-0' />
            {listItem}
          </p>
        ))}
      </div>
      <div className='bg-darkBlue text-center py-4 font-semibold sm:text-lg text-base'>
